...
public class Ship : MonoBehaviour
{
    ...
    // The below variable to track the number of fish collected
    ...
    void OnTriggerStay2D(Collider2D other)
    {
        ...
        if (other.gameObject == targetFish)
        {
            ...
            // Increment the fishCollectedCount by 1 every time a fish is collected
            fishCollectedCount++;
            Debug.Log("Total Fish Collected: " + fishCollectedCount);
            hud.AddPoints(1); // Assuming each fish is worth 100 points.
